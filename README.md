...
> **Option 1 (Recommended):** Click [📦 Download ZIP](https://github.com/ahao0625/ai-workflow-generator/releases/download/v1.1.0/ai-workflow-generator-v1_1.zip)
...
> **方式一（推荐）：** 点击 [📦 下载压缩包](https://github.com/ahao0625/ai-workflow-generator/releases/download/v1.1.0/ai-workflow-generator-v1_1.zip)，解压即用。
